...
<html>
    ...
    <body>
        ...
        <!-- Sidebar -->
    <div class="sidebar">
        <a href="#"><span class="fas fa-user-secret"></span> DJ</a>
...
for(Category cc :list1 )
{
  ...
  %>
       ...
       <!--<li><a class="dropdown-item" onclick="getPosts(0,this)" class=" nav-link dropdown-toggle c-link list-group-item list-group-item-action active"  role="button" data-bs-toggle="dropdown" ><%= cc.getName() %></a></li>-->                    
  
  <li><a class="dropdown-item" href="#" onclick="getPosts(<%= cc.getcId()%>,this)"  class="c-link list-group-item list-group-item-action" style=" color: #9BD7D1; background-color: #0C134F; " ><%= cc.getName() %></a></li>                    
